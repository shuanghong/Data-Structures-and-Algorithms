...
/*****************************
 * 
 * brief: 构造函数, 参数为列表初始化, 任何使用列表初始化的情况: {} 或者 ={}均调用此函数
...
/*****************************
 * 
 * brief: 拷贝构造函数, 如果没有定义，则编译器会在调用的时候生成一个 
...
/*****************************
 * 
 * brief: 拷贝赋值运算符,即重载 = 操作符. 如果没有定义，则编译器会在调用的时候生成一个 
...
/*****************************
 * 
 * brief: 移动构造函数, 如果没有定义，则编译器会在调用的时候生成一个 
...
/*****************************
 * 
 * brief: 析构函数， 可以使用编器器生成， 这里只是为了看打印.
